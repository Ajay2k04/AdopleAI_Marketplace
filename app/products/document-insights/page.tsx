      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-sm md:text-base opacity-90 max-w-prose">
            Transform your documents into actionable insights with advanced AI analysis. Extract key information, 
            identify patterns, and generate comprehensive reports from any document type.
          </p>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        ...
        <ul className="mt-6 space-y-4">
          <li className="border rounded-lg p-4">
            <details open>
              <summary className="font-medium cursor-pointer">AI-Powered Content Extraction</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Automatically extract key information, entities, and insights from PDFs, Word documents, 
                and other formats using advanced natural language processing.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Smart Summarization</summary>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>Generate executive summaries</li>
                <li>Extract key points and themes</li>
          ...
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Pattern Recognition</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Identify trends, anomalies, and patterns across multiple documents. 
                Perfect for compliance monitoring, research analysis, and business intelligence.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Export & Integration</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Export insights to various formats including Excel, JSON, and PDF reports. 
                Integrate with popular business tools and APIs for seamless workflow integration.
              </p>
            </details>
          </li>
        </ul>
      ...
      >
        <img
          src="/img.png"
          alt="Document Insights Dashboard"
...
function renderFeatureValue(name: string, t: { price: number; credits: number }) {
  switch (name) {
    case "Document uploads per month":
      return t.credits === 0 ? 50 : "Unlimited"
    case "AI analysis requests":
    ...
    case "Unlimited storage":
      return t.credits >= 800 ? <span className="text-emerald-500">✓</span> : "Limited"
    default:
      return <span className="text-emerald-500">✓</span>
  }
}
...
function StoryBlock({ theme }: { theme: "dark" | "light" }) {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-[280px,1fr] gap-8">
      ...
      >
        <div className="text-sm">Founded January 10, 2024</div>
        ...
        <a className="mt-4 inline-block text-primary underline" href="https://document-insights.ai/">
          document-insights.ai
        </a>
      </aside>
      <article>
        <h3 className="text-xl md:text-2xl font-semibold mb-3">Revolutionizing document analysis with AI</h3>
        <p className="text-muted-foreground">
          Document Insights was built to solve the challenge of information overload in the digital age. 
          By combining advanced machine learning, natural language processing, and pattern recognition, 
          we've created a system that can understand, analyze, and extract meaningful insights from 
          any document type, helping businesses make data-driven decisions faster than ever before.
        </p>
      </article>
    </section>
  )
...
function Testimonials({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "Document analysis is incredibly accurate", name: "Sarah Johnson", date: "Jan 15, 2025" },
    { title: "Saves hours of manual document review", name: "Michael Chen", date: "Jan 12, 2025" },
    { title: "Perfect for compliance and audit work", name: "Emily Rodriguez", date: "Jan 8, 2025" },
    { title: "AI insights are spot-on every time", name: "David Thompson", date: "Dec 28, 2024" },
    { title: "Integration with our workflow is seamless", name: "Lisa Park", date: "Dec 22, 2024" },
    { title: "Best investment for document intelligence", name: "James Wilson", date: "Dec 18, 2024" },
  ]
  return (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((t, i) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {i % 2
                ? "The AI analysis is incredibly thorough and accurate, identifying patterns I would have missed."
                : "This tool has revolutionized how we process and analyze documents in our organization."}
            </p>
...
function StoriesYoullLove({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "How to Optimize Document Analysis Workflows", date: "Jan 20, 2025" },
    { title: "NEW FEATURE — Advanced Pattern Recognition", date: "Jan 15, 2025" },
    { title: "The Complete Guide to AI Document Processing", date: "Jan 10, 2025" },
  ]
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
...
function InsiderKnowledge({ theme }: { theme: "dark" | "light" }) {
  const faqs = [
    "How do I get started with Document Insights?",
    "What document formats are supported?",
    "How accurate is the AI analysis?",
    "Can I customize the analysis templates?",
        ...
        <div className="mt-6 space-y-3">
          {faqs.map((q, i) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {i % 2
                  ? "We support PDF, DOCX, TXT, HTML, and many other document formats with intelligent content analysis."
                  : "Sign up for free, upload your documents, and start getting AI-powered insights immediately."}
              </p>
            </details>
          ))}
        </div>
